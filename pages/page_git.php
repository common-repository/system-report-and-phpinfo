...
class TwistPress_Developer_Tools_Page_Git extends TwistPress_Developer_Tools_Page
{
	public function __construct()
	{
		$this->title 		= __('Git Repositories', 'twistpress_debug');
		$this->description	= __('Simple list of all git tracked plugins and themes. Exports as a formatted .txt file.', 'twistpress_debug');
	}
