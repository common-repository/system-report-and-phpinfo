...
class TwistPress_Developer_Tools_Page_Report extends TwistPress_Developer_Tools_Page
{
	public function __construct()
	{
		$this->title 		= __('System Report', 'twistpress_debug');
		$this->description	= __('Overview your vital WordPress and environment data. Exports as formatted .txt file.', 'twistpress_debug');
	}
	...
	public function page_data()
	{
		...
		$report	.= 'WP Memory Limit:'."\t\t\t".TwistPress_Developer_Tools::num_convt( WP_MEMORY_LIMIT )/( 1024 ).'MB'."\n";
